...
Player getWinner(Player &p1, Player &p2, Board &board)
{
    ...
    // Loop wird unterbrochen, wenn ein Spieler verliert (nur noch 2 Steine hat)
    {
        ...
        startTurn(p1, board);
        cout << "Bot p2 hat " << p2.getLostChips() << " Chips verloren" << endl;
        cout << "p1 hat " << p1.getLostChips() << " Chips verloren" << endl;
    ...
    if (player.getUnusedChips() > 0)
    {
        ...
        do
        {
            ...
            else
            {
                ...
                cout << "Der Bot will einen Chip setzen auf: " << b.generateChipPlacement() << endl;
            }
